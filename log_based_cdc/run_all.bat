...
echo STEP 2: CHECK AND CLEAN/CREATE CONTAINERS
...
REM Останавливаем через docker-compose
docker-compose down -v
if errorlevel 1 goto :error

REM Собираем образ только если его нет
...
docker exec cdc-spark /opt/spark/bin/spark-submit ^
